            ...
            if (thisEvent[i]['launch_date_unix'] < unix)
                {
                    ...
                    details.innerHTML += "<div style='padding-left:2px;text-align:left; background-color:lightgray;border:1px; border-color:black;border-style: solid; border-color: darkgray; text-decoration-color:black;'><div class='card-container'><a href='"+thisEvent[i]['links']['video_link']+"'><img src='../images/icons/play_video_icon.png' style='width:20px'/></a> " + "<b>Rocket Name:</b> " + thisEvent[i]['rocket']['rocket_name'] +  " on <b>Date:</b> " + time2 + "</div></div>";
                }
